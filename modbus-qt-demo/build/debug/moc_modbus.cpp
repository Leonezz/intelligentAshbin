...
QT_MOC_LITERAL(1, 7, 29), // "tempreatureAndHumidityRecived"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 11), // "tempreature"
QT_MOC_LITERAL(4, 50, 8) // "humidity"

    },
    "Sensor\0tempreatureAndHumidityRecived\0"
    "\0tempreature\0humidity"
};
...
void Sensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->tempreatureAndHumidityRecived((*reinterpret_cast< const uint(*)>(_a[1])),(*reinterpret_cast< const uint(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Sensor::*)(const unsigned int , const unsigned int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sensor::tempreatureAndHumidityRecived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sensor::tempreatureAndHumidityRecived(const unsigned int _t1, const unsigned int _t2)
{
